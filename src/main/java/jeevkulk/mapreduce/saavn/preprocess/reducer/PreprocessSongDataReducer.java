package jeevkulk.mapreduce.saavn.preprocess.reducer;
...
public class PreprocessSongDataReducer extends Reducer<Text, IntWritable, Text, IntWritable> {

    /**
     * This method aggregates the songCount of each songId
     * Job1 Input Key      : songPlayedDate~songId
     * Job1 Input Value    : songCount~numberOfDays
